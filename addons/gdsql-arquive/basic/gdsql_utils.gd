...
static func evaluate_command_with_sql_expression(
		target: Object,
		command: String,
...
## variable_names：参数名称列表
## variable_values：参数值列表
static func evalute_command_with_agg(
		target: GDSQL.AggregateFunctions,
		command: String,
		variable_names: Array = [],
		variable_values: Array = [],
		sql_input_names: Dictionary = { },
