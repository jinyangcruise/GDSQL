...
func _draw():
	...
	draw_dashed_line(Vector2(0, 0) - Vector2(margin_left, margin_top) + Vector2(0, width/2), 
		Vector2(size.x, 0) + Vector2(margin_right, -margin_top) + Vector2(0, width/2), color, a_width, a_width, false)
