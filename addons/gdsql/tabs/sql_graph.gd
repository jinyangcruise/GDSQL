...
func gen_select_node() -> GraphNode:
	...
	var datas: Array[Array] = [
		...
		[null, null, DictionaryObject.new({"Fields": ""}, {"Fields": {"hint": PROPERTY_HINT_MULTILINE_TEXT}})],
		[null, null, DictionaryObject.new({"Where": ""}, {"Where": {"hint": PROPERTY_HINT_MULTILINE_TEXT}})],
		[null, null, DictionaryObject.new({"Order By": "", "_order": 0}, {"_order": {"hint": PROPERTY_HINT_ENUM, "hint_string": "ASC,DESC"}})],
		[null, null, DictionaryObject.new({"Offset": 0})],
		[null, null, DictionaryObject.new({"Limit": 100})],
		[null, null, separator],
		[null, null, btn_query]
	]
...
func gen_left_join_node() -> GraphNode:
	...
	var datas: Array[Array] = [
		...
		[null, null, schema_dict_obj],
		[null, null, table_dict_obj],
		[null, null, DictionaryObject.new({"On": ""}, {"On": {"hint": PROPERTY_HINT_MULTILINE_TEXT}})]
	]
	graph_node.datas = datas
...
func _on_graph_edit_connection_request(from_node: StringName, from_port: int, to_node: StringName, to_port: int) -> void:
	...
	if f_node.get_meta("type") == "Select":
		if t_node.get_meta("type") == "Select":
			if not f_node.is_connected("node_enabled", node_enabled):
