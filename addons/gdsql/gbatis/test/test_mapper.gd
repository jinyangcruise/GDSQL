...
func select_skill_buff_by_skill_id(id: int) -> TestSkillBuffEntity:
	return query("select_skill_buff_by_skill_id", id)
	
#func select_skill_buff_by_skill_id(id: int) -> Array[TestSkillBuffEntity]:
	#return query("select_skill_buff_by_skill_id", id)
